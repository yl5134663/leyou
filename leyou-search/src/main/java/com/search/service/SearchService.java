...
import com.search.client.SpecficationClient;
...
public class SearchService {
    ...
    @Autowired
    private SpecficationClient specficationClient;
    @Autowired
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        // 查询出所有的搜索规格参数
        List<SpecParam> params = specficationClient.querySpecParams(null, spu.getCid3(), null, true);
        // 查询spuDetail。获取规格参数值
    ...
    private List<Map<String,Object>> getParamAggResult(Long id, QueryBuilder basicQuery) {
        ...
        // 查询要聚合的规格参数
        List<SpecParam> params = this.specficationClient.querySpecParams(null, id, null, true);
        // 添加聚合
        params.forEach(param -> {
